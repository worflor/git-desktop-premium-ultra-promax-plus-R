...
class ExternalToolPresets {
  ...
  static List<ExternalToolPreset> get all => [
        ...
        const ExternalToolPreset(label: '+ Ollama', executable: 'ollama', category: ExternalToolCategory.ai, build: ollama),
        // Editors
        const ExternalToolPreset(label: '+ VS Code', executable: 'code', category: ExternalToolCategory.editors, build: vscode),
        const ExternalToolPreset(label: '+ Cursor', executable: 'cursor', category: ExternalToolCategory.editors, build: cursor),
        const ExternalToolPreset(label: '+ Windsurf', executable: 'windsurf', category: ExternalToolCategory.editors, build: windsurf),
        const ExternalToolPreset(label: '+ Zed', executable: 'zed', category: ExternalToolCategory.editors, build: zed),
        const ExternalToolPreset(label: '+ IntelliJ', executable: 'idea', category: ExternalToolCategory.editors, build: idea),
        const ExternalToolPreset(label: '+ Sublime', executable: 'subl', category: ExternalToolCategory.editors, build: sublime),
        const ExternalToolPreset(label: '+ Neovim', executable: 'nvim', category: ExternalToolCategory.editors, build: nvim),
        const ExternalToolPreset(label: '+ Helix', executable: 'hx', category: ExternalToolCategory.editors, build: helix),
        const ExternalToolPreset(label: '+ Emacs', executable: 'emacs', category: ExternalToolCategory.editors, build: emacs),
        const ExternalToolPreset(label: '+ Vim', executable: 'vim', category: ExternalToolCategory.editors, build: vim),
        const ExternalToolPreset(label: '+ Fleet', executable: 'fleet', category: ExternalToolCategory.editors, build: fleet),
        const ExternalToolPreset(label: '+ Lapce', executable: 'lapce', category: ExternalToolCategory.editors, build: lapce),
        // Git GUIs
        const ExternalToolPreset(label: '+ GitHub Desktop', executable: 'github', category: ExternalToolCategory.explore, build: githubDesktop),
        const ExternalToolPreset(label: '+ GitKraken', executable: 'gitkraken', category: ExternalToolCategory.explore, build: gitkraken),
        const ExternalToolPreset(label: '+ Fork', executable: 'fork', category: ExternalToolCategory.explore, build: fork),
        const ExternalToolPreset(label: '+ Sourcetree', executable: 'stree', category: ExternalToolCategory.explore, build: sourcetree),
        const ExternalToolPreset(label: '+ Tower', executable: 'gittower', category: ExternalToolCategory.explore, build: tower),
        // Explore — file browsers, analysis, git TUIs
        const ExternalToolPreset(label: '+ LazyGit', executable: 'lazygit', category: ExternalToolCategory.explore, build: lazygit),
        const ExternalToolPreset(label: '+ Tig', executable: 'tig', category: ExternalToolCategory.explore, build: tig),
        const ExternalToolPreset(label: '+ GitUI', executable: 'gitui', category: ExternalToolCategory.explore, build: gitui),
        const ExternalToolPreset(label: '+ Broot', executable: 'broot', category: ExternalToolCategory.explore, build: broot),
        const ExternalToolPreset(label: '+ Yazi', executable: 'yazi', category: ExternalToolCategory.explore, build: yazi),
        const ExternalToolPreset(label: '+ Ranger', executable: 'ranger', category: ExternalToolCategory.explore, build: ranger),
        const ExternalToolPreset(label: '+ lf', executable: 'lf', category: ExternalToolCategory.explore, build: lf),
        const ExternalToolPreset(label: '+ nnn', executable: 'nnn', category: ExternalToolCategory.explore, build: nnn),
        const ExternalToolPreset(label: '+ Glow', executable: 'glow', category: ExternalToolCategory.explore, build: glow),
        const ExternalToolPreset(label: '+ Dust', executable: 'dust', category: ExternalToolCategory.explore, build: dust),
        const ExternalToolPreset(label: '+ Tokei', executable: 'tokei', category: ExternalToolCategory.explore, build: tokei),
        const ExternalToolPreset(label: '+ Delta', executable: 'delta', category: ExternalToolCategory.explore, build: delta),
        const ExternalToolPreset(label: '+ Difftastic', executable: 'difft', category: ExternalToolCategory.explore, build: difftastic),
        const ExternalToolPreset(label: '+ Terminal', executable: 'wt', category: ExternalToolCategory.explore, build: windowsTerminal),
        const ExternalToolPreset(label: '+ GitHub', executable: 'gh', category: ExternalToolCategory.explore, build: ghBrowse),
        const ExternalToolPreset(label: '+ Onefetch', executable: 'onefetch', category: ExternalToolCategory.explore, build: onefetch),
        const ExternalToolPreset(label: '+ scc', executable: 'scc', category: ExternalToolCategory.explore, build: scc),
        const ExternalToolPreset(label: '+ ast-grep', executable: 'sg', category: ExternalToolCategory.explore, build: astGrep),
        ...
        const ExternalToolPreset(label: '+ Task', executable: 'task', category: ExternalToolCategory.ops, build: taskRunner),
        const ExternalToolPreset(label: '+ Make', executable: 'make', category: ExternalToolCategory.ops, build: make),
        const ExternalToolPreset(label: '+ Act', executable: 'act', category: ExternalToolCategory.ops, build: act),
        const ExternalToolPreset(label: '+ Docker', executable: 'docker', category: ExternalToolCategory.ops, build: docker),
        const ExternalToolPreset(label: '+ K9s', executable: 'k9s', category: ExternalToolCategory.ops, build: k9s),
        const ExternalToolPreset(label: '+ Stern', executable: 'stern', category: ExternalToolCategory.ops, build: stern),
        const ExternalToolPreset(label: '+ Terraform', executable: 'terraform', category: ExternalToolCategory.ops, build: terraform),
        const ExternalToolPreset(label: '+ Pulumi', executable: 'pulumi', category: ExternalToolCategory.ops, build: pulumi),
        const ExternalToolPreset(label: '+ Trivy', executable: 'trivy', category: ExternalToolCategory.ops, build: trivy),
        const ExternalToolPreset(label: '+ Grype', executable: 'grype', category: ExternalToolCategory.ops, build: grype),
        const ExternalToolPreset(label: '+ HTTPie', executable: 'http', category: ExternalToolCategory.ops, build: httpie),
        const ExternalToolPreset(label: '+ Hurl', executable: 'hurl', category: ExternalToolCategory.ops, build: hurl),
        const ExternalToolPreset(label: '+ Bruno', executable: 'bruno', category: ExternalToolCategory.ops, build: bruno),
        const ExternalToolPreset(label: '+ LazyDocker', executable: 'lazydocker', category: ExternalToolCategory.ops, build: lazydocker),
        const ExternalToolPreset(label: '+ DevContainer', executable: 'devcontainer', category: ExternalToolCategory.ops, build: devcontainer),
        const ExternalToolPreset(label: '+ Watchexec', executable: 'watchexec', category: ExternalToolCategory.ops, build: watchexec),
        const ExternalToolPreset(label: '+ mise', executable: 'mise', category: ExternalToolCategory.ops, build: mise),
        const ExternalToolPreset(label: '+ Zellij', executable: 'zellij', category: ExternalToolCategory.ops, build: zellij),
        const ExternalToolPreset(label: '+ git-cliff', executable: 'git-cliff', category: ExternalToolCategory.ops, build: gitCliff),
        const ExternalToolPreset(label: '+ Posting', executable: 'posting', category: ExternalToolCategory.ops, build: posting),
        const ExternalToolPreset(label: '+ usql', executable: 'usql', category: ExternalToolCategory.ops, build: usql),
        const ExternalToolPreset(label: '+ pgcli', executable: 'pgcli', category: ExternalToolCategory.ops, build: pgcli),
        // Git operations
        const ExternalToolPreset(label: '+ Contributors', executable: 'git', category: ExternalToolCategory.gitOps, build: contributors),
        const ExternalToolPreset(label: '+ Branch Map', executable: 'git', category: ExternalToolCategory.gitOps, build: branchMap),
        const ExternalToolPreset(label: '+ This Week', executable: 'git', category: ExternalToolCategory.gitOps, build: thisWeek),
        const ExternalToolPreset(label: '+ Integrity', executable: 'git', category: ExternalToolCategory.gitOps, build: integrity),
        const ExternalToolPreset(label: '+ Reflog', executable: 'git', category: ExternalToolCategory.gitOps, build: reflog),
        const ExternalToolPreset(label: '+ Ghosts', executable: 'git', category: ExternalToolCategory.gitOps, build: ghosts),
        const ExternalToolPreset(label: '+ Cleanup', executable: 'git', category: ExternalToolCategory.gitOps, build: cleanup),
      ];
