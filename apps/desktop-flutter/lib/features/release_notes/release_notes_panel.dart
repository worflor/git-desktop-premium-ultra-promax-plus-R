...
const _changelog = <_ReleaseNote>[
  _ReleaseNote(
    ...
    bullets: [
      ...
      'ai gets all the love these days. what about humans? if you\'ve worked at Google you know Critique, and sources say it\'s the thing people miss most after they leave. so Manifold has one now, git-native and account-free: threads pinned to lines, drafts nobody sees until you publish, turns, verdicts, and comments that anchor to what a line IS and follow it when it moves. consider this its unofficial launch™. it\'s in, it works, it\'s still got cooking to do.',
